package View 
{
	 ...
	 * @author YaoQiao
	 */
	public class GameConnectView extends Sprite 
	{
		/**时间条遮罩 **/
		...
		public function GameConnectView() 
		{
			super();
			init();
		}
		...
		{
			var score:int = int(scoreTF.text);
			return score;
		}
		/**
		 * 初始化
		...
		private function init():void
		{
			...
			//添加游戏排行榜按钮
			var gameOrderBtn:SimpleButton = GameSourceModel.getButtonByName("gameOrderBtn");
			addChild(gameOrderBtn);
			gameOrderBtn.x = 440;
			gameOrderBtn.y = 130;
			buttonsObj["gameOrderBtn"] = gameOrderBtn;
